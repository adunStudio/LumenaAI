...
- 반드시 JSON 형식에 맞춰 반환하세요. '''는 붙이지 마세요.
- 다른 텍스트는 포함하지 마세요.
...
[예시 출력 데이터]
[
    {"term": "2D 오브젝트 만들기", "description": "유니티에서 2D 오브젝트를 만드는 기본적인 방법을 설명합니다."},
    {"term": "유니티 설치", "description": "유니티 엔진을 설치하여 게임 개발을 위한 플랫폼을 준비합니다."},
    {"term": "에셋 가져오기", "description": "필요한 에셋을 다운로드하여 유니티 에디터에 추가합니다."},
    {"term": "오브젝트 만들기", "description": "플레이어 스프라이트를 사용해 게임 캐릭터를 만듭니다."},
    {"term": "컴포넌트 추가", "description": "스프라이트 렌더러, 리지드 바디 2D, 캡슐 콜라이더 2D와 같은 컴포넌트를 유니티 오브젝트에 추가합니다."},
    {"term": "안전성 점검", "description": "프로젝트의 안정성을 높이기 위해 관리 시를 통합합니다."},
    {"term": "게임 캐릭터 설정", "description": "스프라이트 모드를 멀티플로 설정하여 필요한 부분만 자릅니다."},
    {"term": "카메라 및 배경 설정", "description": "기본적인 카메라 설정과 배경색 변경을 통해 시각적인 요소를 점검합니다."},
    {"term": "스크립트 작성 준비", "description": "다음 시간에는 플레이어를 움직일 수 있도록 스크립트를 작성할 예정입니다."},
    {"term": "유니티 에디터 사용", "description": "유니티 에디터를 사용하여 에셋을 추가하고 게임 오브젝트를 설정합니다."},
    {"term": "유니티 설치", "description": "유니티 엔진을 설치하여 게임 개발을 위한 플랫폼을 준비합니다."},
    {"term": "에셋 가져오기", "description": "필요한 에셋을 다운로드하여 유니티 에디터에 추가합니다."}
]
"""
